						...
						<tr bgcolor="#FFF">
							...
							<td align="center" width="70%">
								...
								<table style="margin-bottom:40px;" width="50%" cellpadding="8" cellspacing="1" border="0" bgcolor="#2e00ff">
									<tr>
										<td colspan="2" style="color:#FFF;">Debit/Withdrawl Money</td>
									</tr>
									<tr bgcolor="#FFF">
										<td>A/c No.:</td>
										...
										<td>
                                                            ...
                                                            if(acc_no!=null && mobile!=null)
                                                            {
                                                                if(LoginDAO.checkAuthenticUser(acc_no, mobile))
                                                                {
                                                                    ...
                                                                    %>
                                                                        <form method="POST" action="debit_amt">
                                                                        <table id="data" style="margin-bottom:40px;" width="50%" cellpadding="8" cellspacing="1" border="0" bgcolor="#2e00ff">
                                                                            ...
                                                                            <tr bgcolor="#FFF">
                                                                                    ...
                                                                                    <td>
                                                                                        <input name="particulars" type="text" title="Particulars" placeholder="Particulars" required autocomplete="off" maxlength="60" value="CASH WITHDRAWL SELF">
                                                                                        <br><br>
                                                                                        <%
                                                                                        String query;
                                                                                        ...
                                                                                        S = sd.modBal(query);
                                                                                        %>
                                                                                        <input id="wdl" onkeyup="check()" style="width:100px;" name="withdrawl" type="number" title="Withdrawl" placeholder="Withdrawl" required autocomplete="off" min="1"  autofocus="on">&nbsp;&nbsp;&nbsp;Total Bal.:&nbsp;&#8377;<%= S.getBalance() %>
                                                                                        <input id="bal" name="balance" type="hidden" value="<%= Long.parseLong(S.getBalance()) %>">
                                                                                        <br><br>
                                                                                        <span id="button"><input type='submit' value='Withdrawl Amt.'></span>
                                                                                        &nbsp;&nbsp;
...
<!--                                                                                        <script>
                                                                                            function check()
                                                                                            {
                                                                                                ...
                                                                                                //balance = parseLong(balance);
                                                                                                var withdrawl = document.getElementById("wdl").value;
                                                                                                //withdrawl = parseLong(withdrawl);
                                                                                                if(withdrawl>balance)
                                                                                                {
                                                                                                    document.getElementById("button").innerHTML = "<input type='button' value='Insufficient Amt.'>";
                                                                                                }
                                                                                                else
                                                                                                {
                                                                                                    document.getElementById("button").innerHTML = "<input type='submit' value='Deposit Amt.'>";
                                                                                                }
                                                                                            }
                                                                                        </script>-->
                                                                                    </td>
